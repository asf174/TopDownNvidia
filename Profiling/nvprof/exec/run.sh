...
sudo $(which nvprof) --metrics inst_per_warp,inst_executed,inst_issued,ipc --events elapsed_cycles_sm,active_cycles --unified-memory-profiling off ../../../CUDA/bin/hello_world
